...
>  - указан адрес, который был указан у пользователя в *header* перед переходом на страницу оформления заказа   
>  
>:green_square: изменить телефон нельзя, инпут неактивен    
### инпут подъезда:
...
>    критерии:   
>  - формат отображения : **"Ваш заказ в ресторане: *Название ресторана*"** , пример: **"Ваш заказ в ресторане: Black Star Burger"**
...
>    критерии:   
>  - формат отображения : **"Промокод *Название промокода* применен ✅"** , пример: **"Промокод SBW100 применен ✅"**
...
>:green_square: картинка отображается корректно с точки зрения верстки    
>:green_square: картинка соответствует этому блюду  
>:green_square: название блюда отображается корректно с точки зрения верстки    
>:green_square: название блюда соответствует этому блюду  
>:green_square: цена блюда отображается корректно с точки зрения верстки    
>:green_square: цена блюда соответствует этому блюду  
>:green_square: цена блюда с учетом скидки отображается корректно с точки зрения верстки при наличии промокода  
>:green_square: цена блюда с учетом скидки не отображается при отсутствии промокода  
>:green_square: дополнительная информация о блюде (масса, ккал) отображается корректно с точки зрения верстки, соответствует этому блюду   
