...
## **Навигация**  
> :red_square: находясь на странице оформления заказа, при нажатии :arrow_left: (кнопка навигации в браузере), происходит редирект на предыдущую страницу, посещенную пользователем.   
   **Описание бага:** При нажатии :arrow_left: происходит открытие корзины, если на страницу */ordering* пользователь перешел со страницы ресторана с открытой корзиной, нажав кнопку "заказать" внизу корзины.
...
> :red_square: при обновлении страницы охормления заказа не изменяются:
